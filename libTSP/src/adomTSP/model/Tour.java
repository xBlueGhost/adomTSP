...
public class Tour { 
  ...
  */ 
 public double distance(Parser problem) { 
  ...
  *         by the TSPLIB problem instances; {@code false} otherwise 
  */ 
 public boolean containsFixedEdges(Parser problem) { 
  ...
  *         otherwise 
  */ 
 public boolean isHamiltonianCycle(Parser problem) { 
  DistanceTable distanceTable = problem.getDistanceTable(); 
